 ...
 * 
 * @project haohui-b2b
 * @author lp www.zuidaima.com
 * @create 2012-3-22 下午8:29:01
 */
public class ImageUtil { 
	
	
	private static final String NEW_PATH = "D:/";
    ...
    public static void resize01(String srcImgPath, String outImgPath,float per) {  
        // 得到图片  
        BufferedImage src = InputImage(srcImgPath);  
        int old_w = src.getWidth();  
        // 得到源图宽  
        ...
        g.dispose();  
        // 根据图片尺寸压缩比得到新图的尺寸
        new_w = (int) Math.round(140);  
        new_h = (int) Math.round(140);  
        BufferedImage newImg = new BufferedImage(new_w, new_h,  
                BufferedImage.TYPE_INT_RGB);  
        newImg.getGraphics().drawImage(  
                tempImg.getScaledInstance(new_w, new_h, Image.SCALE_SMOOTH), 0,  
    ...
    public static void resize02(String srcImgPath, String outImgPath,float per) {  
        // 得到图片  
        BufferedImage src = InputImage(srcImgPath);  
        int old_w = src.getWidth();  
        // 得到源图宽  
        ...
        g.dispose();  
        // 根据图片尺寸压缩比得到新图的尺寸
        new_w = (int) Math.round(692);  
        new_h = (int) Math.round(353);  
        BufferedImage newImg = new BufferedImage(new_w, new_h,  
                BufferedImage.TYPE_INT_RGB);  
        newImg.getGraphics().drawImage(  
                tempImg.getScaledInstance(new_w, new_h, Image.SCALE_SMOOTH), 0,  
    ...
    public static void main(String args[]) throws Exception {  
        String srcImg = "D:/qq.jpg";  
        resize(srcImg, NEW_PATH + "qq1.jpg", 0.8f,1f);  
