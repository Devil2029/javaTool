...
public class HttpsRequest {
	...
	public ScanCodeResData savePost(String url, Object xmlObj)
		...
		ScanCodeResData scanPayResData = formXml(result, ScanCodeResData.class);
	 ...
	 * @throws KeyManagementException
	 */
	public boolean createMenuUrl(String url)throws IOException, KeyStoreException, UnrecoverableKeyException,
			NoSuchAlgorithmException, KeyManagementException {
		boolean flag=false;
		if (!hasInit) {
			init();
